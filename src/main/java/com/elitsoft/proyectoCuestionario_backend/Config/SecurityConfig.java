...
public class SecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http.
                ...
                .requestMatchers(new AntPathRequestMatcher("/categoria/**","GET")).hasAnyAuthority(ADMIN, GUEST)
                ...
                .requestMatchers(new AntPathRequestMatcher("/examen/","POST")).hasAnyAuthority(ADMIN, GUEST)
